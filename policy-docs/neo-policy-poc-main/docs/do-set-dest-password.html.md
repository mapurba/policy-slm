DirXMLScript DTD: do-set-dest-password element



# do-set-dest-password

The **<do-set-dest-password>** action
sets the password for an object in the destination datastore, using the value
...
|| [**Tree**](DTD-TREE.html#do-set-dest-password)
