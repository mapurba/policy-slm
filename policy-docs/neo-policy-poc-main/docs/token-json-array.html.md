DirXMLScript DTD: token-json-array element
...
from the enclosed [<arg-string>](./arg-string.html)s.
Each [<arg-string>](./arg-string.html)
is evaluated as an element in the JSON array.
...
> <token-json-array>
> 	<arg-string>
> 		<token-text xml:space="preserve">"John"</token-text>
> 	</arg-string>
> 	<arg-string>
> 		<token-text xml:space="preserve">"Mike"</token-text>
> 	</arg-string>
> 	<arg-string>
> 		<token-text xml:space="preserve">"Alex"</token-text>
> 	</arg-string>
> </token-json-array>
>
> ```

The above example is evaluated as the following JSON array.
...
|| [**Tree**](DTD-TREE.html#token-json-array)
