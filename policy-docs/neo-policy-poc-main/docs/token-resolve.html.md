DirXMLScript DTD: token-resolve element



# token-resolve

**<token-split>**resolved the the DN
specified by <arg-dn> to an association key,
or the association key specified by
<arg-association> to a DN in the datastore
...
> | --- | --- | --- |
> | **datastore** | src   |  dest   the datastore to be queried | #REQUIRED |
...
|| [**Tree**](DTD-TREE.html#token-resolve)
