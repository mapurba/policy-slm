DirXMLScript DTD: token-substring element



# token-substring

**<token-substring>** extracts a substring
of the result of the enclosed tokens.
...
> | --- | --- | --- |
> | **length** | **CDATA**   number of characters to include  negative numbers are interpreted as (total # of characters + length) + 1 (e.g for a string with 5 characters a length of -1 = (5 + (-1)) + 1 = 5, -2 = (5 + (-2)) + 1 = 4, etc.) | -1 |
> | **notrace** | true   |  false   *true*if this element should not be traced during execution of policy | false |
> | **start** | **CDATA**   character index to start with  0 is the first character >0 is an offset from the start if the string -1 is the last character <-1 is an offset from the last character towards the start of the string of the string | 0 |
>
> ---
...
|| [**Tree**](DTD-TREE.html#token-substring)
