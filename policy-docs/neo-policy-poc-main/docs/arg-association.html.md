DirXMLScript DTD: arg-association element



# arg-association

The **<arg-assocation>** argument
specifies an association value for the enclosing
action. Each of the enclosed tokens is evaluated
and the resulting string values are concatenated to
form an association value.
...
|| [**Tree**](DTD-TREE.html#arg-association)
