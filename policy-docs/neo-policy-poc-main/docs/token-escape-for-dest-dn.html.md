DirXMLScript DTD: token-escape-for-dest-dn element



# token-escape-for-dest-dn

**<token-escape-for-dest-dn>**escapes
the result of the enclosed tokens for use in a DN
according to the rules of the destination DN
format.
...
|| [**Tree**](DTD-TREE.html#token-escape-for-dest-dn)
