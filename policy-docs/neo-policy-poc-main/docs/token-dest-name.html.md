DirXMLScript DTD: token-dest-name element



# token-dest-name

**<token-dest-name>** expands to the
unqualified RDN of the destination DN specified in
the [current
...
|| [**Tree**](DTD-TREE.html#token-dest-name)
