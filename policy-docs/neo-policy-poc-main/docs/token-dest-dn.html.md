DirXMLScript DTD: token-dest-dn element



# token-dest-dn

**<token-dest-dn>** expands to the
destination DN specified in the [current
...
automatically to the format of the source datastore
...
> | --- | --- | --- |
> | **convert** | true   |  false   convert to DN format of source datastore | false |
...
|| [**Tree**](DTD-TREE.html#token-dest-dn)
