DirXMLScript DTD: token-association element



# token-association

**<token-association>** expands to the
association value specified in the [current
...
|| [**Tree**](DTD-TREE.html#token-association)
