DirXMLScript DTD: token-added-entitlement element



# token-added-entitlement

**<token-added-entitlement>** expands to
the granted value(s) of the named entitlement in
the [current
...
|| [**Tree**](DTD-TREE.html#token-added-entitlement)
