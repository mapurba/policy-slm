DirXMLScript DTD: token-removed-attr element



# token-removed-attr

**<token-removed-attr>** expands to the
attribute values removed in the [current
operation](policy.html#current_operation) (<remove-attr>). If this
...
|| [**Tree**](DTD-TREE.html#token-removed-attr)
