DirXMLScript DTD: do-clear-dest-attr-value element



# do-clear-dest-attr-value

The **<do-clear-dest-attr-value>** action
causes the all values for the named attribute to be
removed from an object in the destination
datastore. The target object is specified by either
...
|| [**Tree**](DTD-TREE.html#do-clear-dest-attr-value)
