DirXMLScript DTD: do-add-dest-attr-value element



# do-add-dest-attr-value

The **<do-add-dest-attr-value>** action
causes the value specified by [<arg-value>](arg-value.html) to be
added to the named attribute on an object in the
destination datastore. The target object is
...
|| [**Tree**](DTD-TREE.html#do-add-dest-attr-value)
