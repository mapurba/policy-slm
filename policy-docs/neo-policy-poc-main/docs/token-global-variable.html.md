DirXMLScript DTD: token-global-variable element



# token-global-variable

**<token-global-variable>** expands to the
value of the named global configuration value.
...
|| [**Tree**](DTD-TREE.html#token-global-variable)
