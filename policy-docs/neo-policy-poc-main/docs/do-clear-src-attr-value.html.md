DirXMLScript DTD: do-clear-src-attr-value element



# do-clear-src-attr-value

The **<do-clear-src-attr-value>** action
causes the all values for the named attribute to be
removed from an object in the source datastore. The
...
|| [**Tree**](DTD-TREE.html#do-clear-src-attr-value)
