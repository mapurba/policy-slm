DirXMLScript DTD: do-add-dest-object element



# do-add-dest-object

The **<do-add-dest-object>** action causes
an object of type class-name to be created in the
destination datastore with a name and location
provided by [<arg-dn>](arg-dn.html). Any
attribute values to be added as part of the object
creation must be done in subsequent [<do-add-dest-attr-value>](do-add-dest-attr-value.html)
...
|| [**Tree**](DTD-TREE.html#do-add-dest-object)
