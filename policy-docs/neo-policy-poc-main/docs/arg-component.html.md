DirXMLScript DTD: arg-component element



# arg-component

The **<arg-component>** argument provides
values for components of the enclosing [<arg-value>](arg-value.html) if the
type attribute of [<arg-value>](arg-value.html) is
structured. Each of the enclosed tokens is
evaluated and the resulting string values are
concatenated to form the value of the component.
The name of the component is specified by the name
attribute.

### Example

> See **[<arg-value>](arg-value.html).**
...
|| [**Tree**](DTD-TREE.html#arg-component)
