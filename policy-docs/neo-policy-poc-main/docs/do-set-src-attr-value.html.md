DirXMLScript DTD: do-set-src-attr-value element



# do-set-src-attr-value

The **<do-set-src-attr-value>** action
causes the value specified by [<arg-value>](arg-value.html) to be
added to the named attribute on an object in the
source datastore and all other values for that
...
|| [**Tree**](DTD-TREE.html#do-set-src-attr-value)
