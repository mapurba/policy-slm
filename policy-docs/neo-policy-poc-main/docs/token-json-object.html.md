DirXMLScript DTD: token-json-object element
...
is evaluated as a key-value pair where name in
[<arg-string>](./arg-string.html)
is the key and the enclosed text is evaluated as the value.
...
|| [**Tree**](DTD-TREE.html#token-json-object)
