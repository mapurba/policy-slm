DirXMLScript DTD: do-move-dest-object element



# do-move-dest-object

The **<do-move-dest-object>** action
causes an object in the destination datastore to be
moved. If two arguments are provided then the
object identified by the first argument will be
moved to the container identified by the second
argument. If only a single argument is provided
then the [current
...
|| [**Tree**](DTD-TREE.html#do-move-dest-object)
