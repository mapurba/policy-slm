DirXMLScript DTD: token-text element



# token-text

**<token-text>** expands to the enclosed
text.  
*Supports variable expansion*.

While using special characters ' \* ' and ' \ ' as part of **<token-text>** node's enclosed text ,
escape them with ' \ ' in order to consider them as normal characters.
