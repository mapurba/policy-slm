DirXMLScript DTD: token-lower-case element



# token-lower-case

**<token-lower-case>** converts each
character of the result of the enclosed tokens to
lower case.
...
|| [**Tree**](DTD-TREE.html#token-lower-case)
