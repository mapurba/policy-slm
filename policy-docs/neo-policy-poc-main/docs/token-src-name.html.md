DirXMLScript DTD: token-src-name element



# token-src-name

**<token-src-name>** expands to the
unqualified RDN of the source DN specified in the
[current
...
|| [**Tree**](DTD-TREE.html#token-src-name)
