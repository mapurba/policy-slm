DirXMLScript DTD: arg-actions element



# arg-actions

The **<arg-actions>** argument specifies
the actions associated with the enclosing action. It is
different from other argument types in that it
contains actions instead of tokens.

### [Example](do-for-each.html)

> [See](do-for-each.html)
> **[<do-for-each>](do-for-each.html), [<do-if>](do-if.html), [<do-while>](do-while.html), [<do-implement-entitlement>](do-implement-entitlement.html)**.
...
|| [**Tree**](DTD-TREE.html#arg-actions)
