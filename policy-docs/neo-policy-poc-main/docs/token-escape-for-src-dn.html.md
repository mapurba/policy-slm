DirXMLScript DTD: token-escape-for-src-dn element



# token-escape-for-src-dn

**<token-escape-for-src-dn>**escapes
the result of the enclosed tokens for use in a DN
according to the rules of the source DN format.
...
|| [**Tree**](DTD-TREE.html#token-escape-for-src-dn)
