DirXMLScript DTD: or element



# or

**<or>** specifies a set of tests that are
to be performed and whose results are to be
logically or'ed together. A set of <or>'s
