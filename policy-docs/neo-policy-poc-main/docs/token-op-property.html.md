DirXMLScript DTD: token-op-property element



# token-op-property

**<token-op-property>** expands to the
value of the named [operation property](do-set-op-property.html#operation_property) on the [current
...
|| [**Tree**](DTD-TREE.html#token-op-property)
