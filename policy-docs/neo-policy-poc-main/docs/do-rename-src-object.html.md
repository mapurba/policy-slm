DirXMLScript DTD: do-rename-src-object element



# do-rename-src-object

The **<do-rename-src-object>** action
causes an object in the source datastore to be
renamed to the name specifed by [<arg-string>](arg-string.html). The
...
|| [**Tree**](DTD-TREE.html#do-rename-src-object)
