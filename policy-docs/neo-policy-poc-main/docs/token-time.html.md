DirXMLScript DTD: token-time element



# token-time

**<token-time>** time expands to the
current date/time in the format, language and time
zone specified by *format*, *lang*,
and *tz*.
...
> | **tz** | **CDATA**   the time zone (defaults to the current system timezone)  *supports variable expansion* | #IMPLIED |
>
> ---
