DirXMLScript DTD: token-src-attr element



# token-src-attr

**<token-src-attr>** expands to the
attribute values of the [current
object](policy.html#current_object) in the source datastore. If this
...
|| [**Tree**](DTD-TREE.html#token-src-attr)
