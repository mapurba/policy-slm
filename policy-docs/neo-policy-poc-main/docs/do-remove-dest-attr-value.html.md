DirXMLScript DTD: do-remove-dest-attr-value element



# do-remove-dest-attr-value

The **<do-remove-dest-attr-value>** action
causes the value specified by [<arg-value>](arg-value.html) to be
removed from the named attribute on an object in
the destination datastore. The target object is
specified by either [<arg-dn>](arg-dn.html) or [<arg-association>](arg-association.html)
...
|| [**Tree**](DTD-TREE.html#do-remove-dest-attr-value)
