DirXMLScript DTD: do-rename-dest-object element



# do-rename-dest-object

The **<do-rename-dest-object>** action
causes an object in the destination datastore to be
renamed to the name specified by [<arg-string>](arg-string.html). The
target object is specified by either [<arg-dn>](arg-dn.html)
or [<arg-association>](arg-association.html)
...
|| [**Tree**](DTD-TREE.html#do-rename-dest-object)
