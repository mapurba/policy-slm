...
Because these tasks, as well as several others, are common to all Identity Manager drivers, they are included in one reference, the [NetIQ Identity Manager Driver Administration Guide](../../../identity-manager-49/driver_admin/data/bktitle.html#bktitle).
