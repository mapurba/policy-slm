...
10. Modify the driver configuration settings. See [Configuring the Driver Object](create-driver-object-designer.html#bfveihb).
11. Deploy the driver. See [Deploying the Driver Object](create-driver-object-designer.html#bfvehvc).
12. Start the driver. See [Starting the Driver](create-driver-object-designer.html#bfvehvw).
13. Repeat [Step 1](add-package-existing-driver.html#brf108l) through [Step 9](add-package-existing-driver.html#brf1b87) for each driver where you want to add the new packages.
