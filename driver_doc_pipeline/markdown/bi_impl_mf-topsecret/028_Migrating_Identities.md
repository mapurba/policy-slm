...
3. Specify your search criteria:
   ...
   3. Select the attributes to be used as search criteria for objects of the selected class, then click OK.
      ...
      The eDirectory attributes map to Top Secret attributes as specified by the driver schema: CN maps to ACID, etc. For the default mappings, see [Table 1-1, Default Filter and Schema Mapping](b3wx9up.html#b456yf7).
