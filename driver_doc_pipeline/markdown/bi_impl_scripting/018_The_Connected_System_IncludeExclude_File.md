...
* [Include/Exclude Processing](b8n6prd.html#b8n6pre)
* [Include/Exclude File Syntax](b8n6prd.html#b8n6prf)
* [Example Include/Exclude Files](b8n6prd.html#b8n6pro)
...
Class and attribute names used in the include/exclude file must correspond to the names specified in the schema file. For details about the schema file, see [The Connected System Schema File](b8n6pr6.html).
...
An attribute matching rule comprises an attribute name, an equals sign (=), and an expression. The expression can be an exact value, or it can use limited regular expressions. For details about limited regular expressions, see [Limited Regular Expressions](b8n6prd.html#b8n6prn).
...
You can specify association matching rules in an include or exclude section. Association matching rule expressions can specify an exact association or a limited regular expression. For details about limited regular expressions, see [Limited Regular Expressions](b8n6prd.html#b8n6prn).

The way associations are formed can be customized for an implementation. (See [Scripting Driver Data Definition](b8n5d0x.html) for more information.)
...
You must specify either an association or an attribute matching expression. The syntax of the association and attribute matching expression is the same as that of association matching rules and attribute matching rules previously described. For details, see [Association Matching Rules](b8n6prd.html#b8n6prl) and [Attribute Matching Rules](b8n6prd.html#b8n6prk).
...
* [Example 1](b8n6prd.html#b8n6prp)
* [Example 2](b8n6prd.html#b8n6prq)
* [Example 3](b8n6prd.html#b8n6prr)
