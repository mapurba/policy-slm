...
The JMS driver is part of the Identity Manager Integration Module for Messaging.
...
If you create a new JMS driver in a driver set that already includes an activated driver from this integration module, the new driver inherits the activation from the driver set.
