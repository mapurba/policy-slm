...
The Identity Manager driver for SAP Portal is part of the Identity Manager Integration Module for SAP Enterprise. This integration module includes the following drivers:
...
If you create a new SAP Portal driver in a driver set that already includes an activated driver from this integration module, the new driver inherits the activation from the driver set.
