# 3.4 Adding Packages to an Existing Driver
...
2. Click Packages, then click the Add Packages icon ![Driver icon](../graphics/icon_plus_green_n.png "Driver icon").
...
5. Click Apply to install all of the packages listed with the Install operation.
   ...
   ![](../graphics/packman_install_a.png)
...
8. Click OK to close the Package Management page after you have reviewed the installed packages.
   ...
   ![](../graphics/packman_installed_a.png)
9. Repeat [Step 1](adding-packages-to-existing-identity-manager-sap-portal-driver.html#brf108l) through [Step 8](adding-packages-to-existing-identity-manager-sap-portal-driver.html#brf1b87) for each driver where you want to add the new packages.
