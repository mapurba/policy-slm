...
9. Repeat [Step 1](adding-packages-to-an-existing-driver.html#brf108l) through [Step 8](adding-packages-to-an-existing-driver.html#brf1b87) for each driver where you want to add the new packages.
