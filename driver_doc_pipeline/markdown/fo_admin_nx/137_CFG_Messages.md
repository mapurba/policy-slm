...
Possible Cause:
The statement is typed wrong or the statement name is used only in a newer version of the software.
...
Explanation:
Could not parse a statement name on the configuration line.
