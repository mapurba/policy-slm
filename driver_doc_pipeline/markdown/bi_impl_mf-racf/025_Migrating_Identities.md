...
* [Migrating Identities from the Identity Vault to the Connected System](b3xxotz.html#b3xxpl3)
* [Migrating Identities from the Connected System to the Identity Vault](b3xxotz.html#b3xxw83)
* [Synchronizing the Driver](b3xxotz.html#b3xyhgj)
...
3. Specify your search criteria:
   ...
   3. Select the attributes to be used as search criteria for objects of the selected class, then click OK.
      ...
      The eDirectory attributes map to RACF attributes as specified by the driver schema: CN maps to DirXML-RACF-userid, etc. For the default mappings, see [Table 1-2, Default Filter and Schema Mapping](b3wx9up.html#b456yf7).
