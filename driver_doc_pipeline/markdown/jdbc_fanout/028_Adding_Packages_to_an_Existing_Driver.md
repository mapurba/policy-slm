...
2. Click Packages, then upgrade the already installed driver Base package.
...
3. Click the Add Packages icon ![](../graphics/icon_plus_green_n.png).
...
10. Modify the driver configuration settings. See [Configuring the Driver Object](how-to-create-jdbc-fan-out-driver-object-in-designer.html#b1ij9iht).
11. Deploy the driver. See [Deploying the Driver Object](how-to-create-jdbc-fan-out-driver-object-in-designer.html#b1ij9ihv).
12. Start the driver. See [Starting the Driver](how-to-create-jdbc-fan-out-driver-object-in-designer.html#b1ij9j9g).
13. Repeat [Step 1](how-to-add-packages-to-the-existing-jdbc-fan-out-driver.html#brf108l) through [Step 9](how-to-add-packages-to-the-existing-jdbc-fan-out-driver.html#brf1b87) for each driver where you want to add the new packages.
