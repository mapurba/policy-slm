...
The driver shim configuration file /etc/nxdrv.conf controls operation of the driver shim. You can specify the configuration options listed in [Table 5-4](b4baik6.html#b4572iu), one per line. You can also specify these options on the driver shim command line. For details about driver shim command line options, see [Driver Shim Command Line Options](b3yj43k.html).
