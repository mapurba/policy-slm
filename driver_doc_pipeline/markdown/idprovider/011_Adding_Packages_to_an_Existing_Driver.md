# 3.5 Adding Packages to an Existing Driver
...
2. Click Packages, then click the Add Packages icon ![ID policy icon](../graphics/icon_plus_green_n.png "ID policy icon").
...
9. Repeat [Step 1](add-packages-to-the-existing-id-provider-driver.html#brf108l) through [Step 8](add-packages-to-the-existing-id-provider-driver.html#brf1b87) for each driver where you want to add the new packages.
