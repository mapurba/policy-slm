...
2. Click Packages, then upgrade the already installed Oracle EBS User Management Base package.
...
3. Click the Add Packages icon ![Driver icon](../graphics/icon_plus_green_n.png "Driver icon").
...
10. Modify the driver configuration settings. See [Configuring the Driver Object](creating-the-driver-object-in-designer.html#bfveihb).
11. Deploy the driver. See [Deploying the Driver Object](creating-the-driver-object-in-designer.html#bfvehvc).
12. Start the driver. See [Starting the Driver](creating-the-driver-object-in-designer.html#bfvehvw).
13. Repeat [Step 1](adding-packages-to-an-existing-driver.html#brf108l) through [Step 9](adding-packages-to-an-existing-driver.html#brf1b87) for each driver where you want to add the new packages.
