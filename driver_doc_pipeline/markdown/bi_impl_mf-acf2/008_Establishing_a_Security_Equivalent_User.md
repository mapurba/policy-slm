...
The driver user must be a trustee of the containers where synchronized users reside, with the rights shown in [Table 2-2](b484ok2.html#b4exk92). Inheritance must be set for [Entry Rights] and [All Attribute Rights].
