...
| Startup | 0.90 seconds | 890 | 1338 (5.5 MB) |
| Idle (not connected) | 0.12 seconds/hour | 0/hour | 1338 (5.9 MB) |
| Connection | 1.55 seconds | 40 | 1935 (7.9 MB) |
| Idle (connected) | 0.6 seconds/hour | 12/hour | 1935 (7.9 MB) |
...
| Add User | 1.16 seconds | 216 | 2900 (11.9 MB) | 2.02 seconds |
| Modify User | 0.48 seconds | 181 | 2200 (9.0 MB) | 1.11 seconds |
| Delete User | 0.79 seconds | 287 | 2043 (8.4 MB) | 1.66 seconds |
| Change Password | 0.74 seconds | 399 | 2008 (8.2 MB) | 0.79 seconds |
| Entry Query User | 0.27 seconds | 93 | 2008 (8.2 MB) | 1.00 seconds |
...
When LDXLOGRP (monitored on the mainframe as LDXLOGRP) is not bottlenecked by ACF2 and started after the cross memory queue is populated with events, the CPU-Time and Real Time performance is more efficient. This is demonstrated by the bulk processing results in [Table C-7](bmn9uvw.html#bqkpn80).
...
| Add Group | 0.023 seconds | 7 | 1976 (8.1 MB) | 0.12 seconds |
